...
URL Source: http://developers.openai.com/codex/cli/reference

Published Time: Fri, 06 Feb 2026 22:22:51 GMT
...
The CLI inherits most defaults from `~/.codex/config.toml`. Any `-c key=value` overrides you pass at the command line take precedence for that invocation. See [Config basics](http://developers.openai.com/codex/config-basic#configuration-precedence) for more information.
...
| --- | --- | --- |
| [`codex`](http://developers.openai.com/codex/cli/reference#codex-interactive) | Stable | Launch the terminal UI. Accepts the global flags above plus an optional prompt or image attachments. |
| [`codex app-server`](http://developers.openai.com/codex/cli/reference#codex-app-server) | Experimental | Launch the Codex app server for local development or debugging. |
| [`codex apply`](http://developers.openai.com/codex/cli/reference#codex-apply) | Stable | Apply the latest diff generated by a Codex Cloud task to your local working tree. Alias: `codex a`. |
| [`codex cloud`](http://developers.openai.com/codex/cli/reference#codex-cloud) | Experimental | Browse or execute Codex Cloud tasks from the terminal without opening the TUI. Alias: `codex cloud-tasks`. |
| [`codex completion`](http://developers.openai.com/codex/cli/reference#codex-completion) | Stable | Generate shell completion scripts for Bash, Zsh, Fish, or PowerShell. |
| [`codex exec`](http://developers.openai.com/codex/cli/reference#codex-exec) | Stable | Run Codex non-interactively. Alias: `codex e`. Stream results to stdout or JSONL and optionally resume previous sessions. |
| [`codex execpolicy`](http://developers.openai.com/codex/cli/reference#codex-execpolicy) | Experimental | Evaluate execpolicy rule files and see whether a command would be allowed, prompted, or blocked. |
| [`codex features`](http://developers.openai.com/codex/cli/reference#codex-features) | Stable | List feature flags and persistently enable or disable them in `config.toml`. |
| [`codex fork`](http://developers.openai.com/codex/cli/reference#codex-fork) | Stable | Fork a previous interactive session into a new thread, preserving the original transcript. |
| [`codex login`](http://developers.openai.com/codex/cli/reference#codex-login) | Stable | Authenticate Codex using ChatGPT OAuth, device auth, or an API key piped over stdin. |
| [`codex logout`](http://developers.openai.com/codex/cli/reference#codex-logout) | Stable | Remove stored authentication credentials. |
| [`codex mcp`](http://developers.openai.com/codex/cli/reference#codex-mcp) | Experimental | Manage Model Context Protocol servers (list, add, remove, authenticate). |
| [`codex mcp-server`](http://developers.openai.com/codex/cli/reference#codex-mcp-server) | Experimental | Run Codex itself as an MCP server over stdio. Useful when another agent consumes Codex. |
| [`codex resume`](http://developers.openai.com/codex/cli/reference#codex-resume) | Stable | Continue a previous interactive session by ID or resume the most recent conversation. |
| [`codex sandbox`](http://developers.openai.com/codex/cli/reference#codex-sandbox) | Experimental | Run arbitrary commands inside Codex-provided macOS seatbelt or Linux landlock sandboxes. |

Key

[`codex`](http://developers.openai.com/codex/cli/reference#codex-interactive)
...
[`codex app-server`](http://developers.openai.com/codex/cli/reference#codex-app-server)
...
[`codex apply`](http://developers.openai.com/codex/cli/reference#codex-apply)
...
[`codex cloud`](http://developers.openai.com/codex/cli/reference#codex-cloud)
...
[`codex completion`](http://developers.openai.com/codex/cli/reference#codex-completion)
...
[`codex exec`](http://developers.openai.com/codex/cli/reference#codex-exec)
...
[`codex execpolicy`](http://developers.openai.com/codex/cli/reference#codex-execpolicy)
...
[`codex features`](http://developers.openai.com/codex/cli/reference#codex-features)
...
[`codex fork`](http://developers.openai.com/codex/cli/reference#codex-fork)
...
[`codex login`](http://developers.openai.com/codex/cli/reference#codex-login)
...
[`codex logout`](http://developers.openai.com/codex/cli/reference#codex-logout)
...
[`codex mcp`](http://developers.openai.com/codex/cli/reference#codex-mcp)
...
[`codex mcp-server`](http://developers.openai.com/codex/cli/reference#codex-mcp-server)
...
[`codex resume`](http://developers.openai.com/codex/cli/reference#codex-resume)
...
[`codex sandbox`](http://developers.openai.com/codex/cli/reference#codex-sandbox)
...
*   [Codex CLI overview](http://developers.openai.com/codex/cli): installation, upgrades, and quick tips.
*   [Config basics](http://developers.openai.com/codex/config-basic): persist defaults like the model and provider.
*   [Advanced Config](http://developers.openai.com/codex/config-advanced): profiles, providers, sandbox tuning, and integrations.
*   [AGENTS.md](http://developers.openai.com/codex/guides/agents-md): conceptual overview of Codex agent capabilities and best practices.

[Previous Features](http://developers.openai.com/codex/cli/features)[Next Slash commands](http://developers.openai.com/codex/cli/slash-commands)
